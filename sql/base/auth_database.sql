-- MySQL dump 10.13  Distrib 5.6.24-rc, for Win64 (x86_64)
--
-- Host: localhost    Database: auth
-- ------------------------------------------------------
-- Server version	5.6.24-rc
...
INSERT INTO `realmlist` VALUES (1,'Tournament','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,0,1,0,0,12340);
...
CREATE TABLE `uptime` (
  ...
  `revision` varchar(255) NOT NULL DEFAULT 'Tournamentcore',
