...
#ifndef _TOURNAMENT_REALM_CONFIG
# define _TOURNAMENT_REALM_CONFIG  "authserver.conf"
#endif
...
variables_map GetConsoleArguments(int argc, char** argv, std::string& configFile)
{
    ...
    all.add_options()
		...
		("config,c", value<std::string>(&configFile)->default_value(_TOURNAMENT_REALM_CONFIG), "use <arg> as configuration file")
        ;
