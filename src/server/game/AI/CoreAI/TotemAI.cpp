...
void TotemAI::UpdateAI(uint32 /*diff*/)
{
    ...
    {
        victim = NULL;
		Tournament::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
		Tournament::UnitLastSearcher<Tournament::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
