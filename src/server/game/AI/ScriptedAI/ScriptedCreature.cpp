...
std::list<Creature*> ScriptedAI::DoFindFriendlyCC(float range)
{
	...
	Tournament::CreatureListSearcher<Tournament::FriendlyCCedInRange> searcher(me, list, u_check);
    me->VisitNearbyObject(range, searcher);
...
{
    std::list<Creature*> list;
	Tournament::FriendlyMissingBuffInRange u_check(me, range, uiSpellid);
...
Player* ScriptedAI::GetPlayerAtMinimumRange(float minimumRange)
{
	...
	CellCoord pair(Tournament::ComputeCellCoord(me->GetPositionX(), me->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

	Tournament::PlayerAtMinimumRangeAway check(me, minimumRange);
	Tournament::PlayerSearcher<Tournament::PlayerAtMinimumRangeAway> searcher(me, player, check);
	TypeContainerVisitor<Tournament::PlayerSearcher<Tournament::PlayerAtMinimumRangeAway>, GridTypeMapContainer> visitor(searcher);
