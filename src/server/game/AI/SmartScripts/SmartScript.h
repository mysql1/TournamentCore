...
#ifndef TOURNAMENT_SMARTSCRIPT_H
#define TOURNAMENT_SMARTSCRIPT_H
...
class SmartScript
{
    public:
        ...
        Creature* FindCreatureNear(WorldObject* searchObject, uint32 guid) const
        {
			...
			Tournament::CreatureWithDbGUIDCheck target_check(searchObject, guid);
			Tournament::CreatureSearcher<Tournament::CreatureWithDbGUIDCheck> checker(searchObject, creature, target_check);
