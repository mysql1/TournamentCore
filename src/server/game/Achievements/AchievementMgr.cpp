...
void AchievementMgr::SendAchievementEarned(AchievementEntry const* achievement) const
{
    ...
    {
		Tournament::BroadcastTextBuilder _builder(GetPlayer(), CHAT_MSG_GUILD_ACHIEVEMENT, BROADCAST_TEXT_ACHIEVEMENT_EARNED, GetPlayer(), achievement->ID);
		Tournament::LocalizedPacketDo<Tournament::BroadcastTextBuilder> _localizer(_builder);
    ...
    {
		Tournament::BroadcastTextBuilder _builder(GetPlayer(), CHAT_MSG_ACHIEVEMENT, BROADCAST_TEXT_ACHIEVEMENT_EARNED, GetPlayer(), achievement->ID);
		Tournament::LocalizedPacketDo<Tournament::BroadcastTextBuilder> _localizer(_builder);
		Tournament::PlayerDistWorker<Tournament::LocalizedPacketDo<Tournament::BroadcastTextBuilder> > _worker(GetPlayer(), sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), _localizer);
