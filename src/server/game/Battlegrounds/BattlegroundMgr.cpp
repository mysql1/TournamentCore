...
void BattlegroundMgr::BuildBattlegroundListPacket(WorldPacket* data, ObjectGuid guid, Player* player, BattlegroundTypeId bgTypeId, uint8 fromWhere)
{
	...
	winner_kills = Tournament::Honor::hk_honor_at_level(player->getLevel(), float(winner_kills));
	loser_kills = Tournament::Honor::hk_honor_at_level(player->getLevel(), float(loser_kills));
