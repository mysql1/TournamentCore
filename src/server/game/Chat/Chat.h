...
#ifndef TOURNAMENTCORE_CHAT_H
#define TOURNAMENTCORE_CHAT_H
...
class ChatHandler
{
    public:
		...
		virtual char const* GetTournamentString(uint32 entry) const;
        ...
        {
			SendSysMessage(Tournament::StringFormat(fmt, args...).c_str());
        }
        ...
        {
			return Tournament::StringFormat(GetTournamentString(entry), args...);
        }
...
class CliHandler : public ChatHandler
{
    public:
        ...
        // overwrite functions
		char const* GetTournamentString(uint32 entry) const override;
