...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
		...
		CellCoord p(Tournament::ComputeCellCoord(GetPositionX(), GetPositionY()));
        Cell cell(p);
        cell.SetNoCreate();
		Tournament::NearestAssistCreatureInCreatureRangeCheck u_check(this, GetVictim(), radius);
		Tournament::CreatureLastSearcher<Tournament::NearestAssistCreatureInCreatureRangeCheck> searcher(this, creature, u_check);

		TypeContainerVisitor<Tournament::CreatureLastSearcher<Tournament::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
{
	if (Tournament::XP::GetColorCode(playerLevel, creatureLevel) != XP_GRAY)
        return false;
...
Unit* Creature::SelectNearestTarget(float dist, bool playerOnly /* = false */) const
{
...

    {
		...
		Tournament::NearestHostileUnitCheck u_check(this, dist, playerOnly);
		Tournament::UnitLastSearcher<Tournament::NearestHostileUnitCheck> searcher(this, target, u_check);

		TypeContainerVisitor<Tournament::UnitLastSearcher<Tournament::NearestHostileUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
		TypeContainerVisitor<Tournament::UnitLastSearcher<Tournament::NearestHostileUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetInAttackDistance(float dist) const
{
    ...
    {
		Tournament::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
		Tournament::UnitLastSearcher<Tournament::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

		TypeContainerVisitor<Tournament::UnitLastSearcher<Tournament::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
		TypeContainerVisitor<Tournament::UnitLastSearcher<Tournament::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Player* Creature::SelectNearestPlayer(float distance) const
{
	...
	Tournament::NearestPlayerInObjectRangeCheck checker(this, distance);
	Tournament::PlayerLastSearcher<Tournament::NearestPlayerInObjectRangeCheck> searcher(this, target, checker);
    ...
    if (!m_AlreadyCallAssistance && GetVictim() && !IsPet() && !IsCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
				...
				Tournament::AnyAssistCreatureInRangeCheck u_check(this, GetVictim(), radius);
				Tournament::CreatureListSearcher<Tournament::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

				TypeContainerVisitor<Tournament::CreatureListSearcher<Tournament::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float radius)
{
	...
	Tournament::CallOfHelpCreatureInRangeDo u_do(this, GetVictim(), radius);
	Tournament::CreatureWorker<Tournament::CallOfHelpCreatureInRangeDo> worker(this, u_do);

	TypeContainerVisitor<Tournament::CreatureWorker<Tournament::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
...
void Creature::SetPosition(float x, float y, float z, float o)
{
	...
	if (!Tournament::IsValidMapCoord(x, y, z, o))
    {
...
Unit* Creature::SelectNearestHostileUnitInAggroRange(bool useLOS) const
{
    ...
    {
		Tournament::NearestHostileUnitInAggroRangeCheck u_check(this, useLOS);
		Tournament::UnitSearcher<Tournament::NearestHostileUnitInAggroRangeCheck> searcher(this, target, u_check);
