...
void WorldObject::GetRandomPoint(const Position &pos, float distance, float &rand_x, float &rand_y, float &rand_z) const
{
	...
	Tournament::NormalizeMapCoord(rand_x);
	Tournament::NormalizeMapCoord(rand_y);
...
{
	return Tournament::IsValidMapCoord(m_positionX, m_positionY, m_positionZ, m_orientation);
}
...
{
	Tournament::MessageDistDeliverer notifier(this, data, dist);
    VisitNearbyWorldObject(dist, notifier);
}

void WorldObject::SendMessageToSet(WorldPacket* data, Player const* skipped_rcvr)
{
	Tournament::MessageDistDeliverer notifier(this, data, GetVisibilityRange(), false, skipped_rcvr);
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive) const
{
	...
	Tournament::NearestCreatureEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
	Tournament::CreatureLastSearcher<Tournament::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
{
    GameObject* go = NULL;
	Tournament::NearestGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
	Tournament::GameObjectLastSearcher<Tournament::NearestGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
...
{
    GameObject* go = NULL;
	Tournament::NearestGameObjectTypeInObjectRangeCheck checker(*this, type, range);
	Tournament::GameObjectLastSearcher<Tournament::NearestGameObjectTypeInObjectRangeCheck> searcher(this, go, checker);
    VisitNearbyGridObject(range, searcher);
    return go;
}
...
{
	CellCoord pair(Tournament::ComputeCellCoord(this->GetPositionX(), this->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

	Tournament::AllGameObjectsWithEntryInRange check(this, entry, maxSearchRange);
	Tournament::GameObjectListSearcher<Tournament::AllGameObjectsWithEntryInRange> searcher(this, gameobjectList, check);
	TypeContainerVisitor<Tournament::GameObjectListSearcher<Tournament::AllGameObjectsWithEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>& creatureList, uint32 entry, float maxSearchRange) const
{
	...
	Tournament::AllCreaturesOfEntryInRange check(this, entry, maxSearchRange);
	Tournament::CreatureListSearcher<Tournament::AllCreaturesOfEntryInRange> searcher(this, creatureList, check);
	TypeContainerVisitor<Tournament::CreatureListSearcher<Tournament::AllCreaturesOfEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
{
	Tournament::AnyPlayerInObjectRangeCheck checker(this, maxSearchRange);
	Tournament::PlayerListSearcher<Tournament::AnyPlayerInObjectRangeCheck> searcher(this, playerList, checker);
...
void WorldObject::GetNearPoint2D(float &x, float &y, float distance2d, float absAngle) const
{
	...
	Tournament::NormalizeMapCoord(x);
	Tournament::NormalizeMapCoord(y);
}
...
void WorldObject::MovePosition(Position &pos, float dist, float angle)
{
	...
	if (!Tournament::IsValidMapCoord(destx, desty, pos.m_positionZ))
    {
	...
	Tournament::NormalizeMapCoord(pos.m_positionX);
	Tournament::NormalizeMapCoord(pos.m_positionY);
...
void WorldObject::MovePositionToFirstCollision(Position &pos, float dist, float angle)
{
    ...
    // Prevent invalid coordinates here, position is unchanged
	if (!Tournament::IsValidMapCoord(destx, desty))
    {
...
void WorldObject::DestroyForNearbyPlayers()
{
	...
	Tournament::AnyPlayerInObjectRangeCheck check(this, GetVisibilityRange(), false);
	Tournament::PlayerListSearcher<Tournament::AnyPlayerInObjectRangeCheck> searcher(this, targets, check);
...
void WorldObject::UpdateObjectVisibility(bool /*forced*/)
{
	...
	Tournament::VisibleChangesNotifier notifier(*this);
    VisitNearbyWorldObject(GetVisibilityRange(), notifier);
}
