...
void WorldSession::HandleWhoOpcode(WorldPacket& recvData)
{
    ...
    // client send in case not set max level value 100 but Tournament supports 255 max level,
...
void WorldSession::HandleAddFriendOpcode(WorldPacket& recvData)
{
	...
	std::string friendName = GetTournamentString(LANG_FRIEND_IGNORE_UNKNOWN);
...
void WorldSession::HandleAddIgnoreOpcode(WorldPacket& recvData)
{
	...
	std::string ignoreName = GetTournamentString(LANG_FRIEND_IGNORE_UNKNOWN);
...
void WorldSession::HandleMoveTimeSkippedOpcode(WorldPacket& recvData)
{
    ...
    /*
        ...
        //// @todo
        must be need use in Tournament
