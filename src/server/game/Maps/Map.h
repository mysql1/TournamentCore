...
class InstanceMap;
class Transport;
namespace Tournament { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
		...
		void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<Tournament::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<Tournament::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
			return IsGridLoaded(Tournament::ComputeGridCoord(x, y));
        }
