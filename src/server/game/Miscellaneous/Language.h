...
#ifndef __TOURNAMENT_LANGUAGE_H
#define __TOURNAMENT_LANGUAGE_H
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    // Room for more Tournament strings      5062-9999
