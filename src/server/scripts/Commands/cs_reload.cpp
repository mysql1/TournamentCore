...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "tournament_string",             rbac::RBAC_PERM_COMMAND_RELOAD_TOURNAMENT_STRING,                true,  &HandleReloadTournamentStringCommand,           "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
		...
		HandleReloadTournamentStringCommand(handler, "");
	...
	static bool HandleReloadTournamentStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        TC_LOG_INFO("misc", "Re-Loading tournament_string Table!");
		sObjectMgr->LoadTournamentStrings();
        handler->SendGlobalGMSysMessage("DB table `tournament_string` reloaded.");
        return true;
    }
