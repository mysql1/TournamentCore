        ...
        struct boss_akilzonAI : public BossAI
        {
            ...
            void HandleStormSequence(Unit* Cloud) // 1: begin, 2-9: tick, 10: end
            {
                if (StormCount < 10 && StormCount > 1)
                {
                    ...
                    {
						Tournament::AnyAoETargetUnitInObjectRangeCheck u_check(me, me, SIZE_OF_GRIDS);
						Tournament::UnitListSearcher<Tournament::AnyAoETargetUnitInObjectRangeCheck> searcher(me, tempUnitMap, u_check);

						TypeContainerVisitor<Tournament::UnitListSearcher<Tournament::AnyAoETargetUnitInObjectRangeCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
						TypeContainerVisitor<Tournament::UnitListSearcher<Tournament::AnyAoETargetUnitInObjectRangeCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
