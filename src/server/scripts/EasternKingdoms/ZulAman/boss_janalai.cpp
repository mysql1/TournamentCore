        ...
        //        DoZoneInCombat();
            ...
            bool HatchAllEggs(uint32 action) //1: reset, 2: isHatching all
            {
...

                {
					...
					Tournament::AllCreaturesOfEntryInRange check(me, NPC_EGG, 100);
					Tournament::CreatureListSearcher<Tournament::AllCreaturesOfEntryInRange> searcher(me, templist, check);

					TypeContainerVisitor<Tournament::CreatureListSearcher<Tournament::AllCreaturesOfEntryInRange>, GridTypeMapContainer> cSearcher(searcher);
            ...
            void Boom()
            {
...

                {
					...
					Tournament::AllCreaturesOfEntryInRange check(me, NPC_FIRE_BOMB, 100);
					Tournament::CreatureListSearcher<Tournament::AllCreaturesOfEntryInRange> searcher(me, templist, check);
        ...
        struct npc_janalai_hatcherAI : public ScriptedAI
        {
            ...
            bool HatchEggs(uint32 num)
            {
...

                {
					...
					Tournament::AllCreaturesOfEntryInRange check(me, 23817, 50);
					Tournament::CreatureListSearcher<Tournament::AllCreaturesOfEntryInRange> searcher(me, templist, check);
