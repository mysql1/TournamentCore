        ...
        struct boss_nalorakkAI : public ScriptedAI
        {
            ...
            void SendAttacker(Unit* target)
            {
...

                {
					...
					Tournament::AllFriendlyCreaturesInGrid check(me);
					Tournament::CreatureListSearcher<Tournament::AllFriendlyCreaturesInGrid> searcher(me, templist, check);

					TypeContainerVisitor<Tournament::CreatureListSearcher<Tournament::AllFriendlyCreaturesInGrid>, GridTypeMapContainer> cSearcher(searcher);
