...
public:
    ...
    struct npc_geezleAI : public ScriptedAI
    {
        ...
        void CompleteQuest()
        {
			...
			Tournament::AnyPlayerInObjectRangeCheck checker(me, radius);
			Tournament::PlayerListSearcher<Tournament::AnyPlayerInObjectRangeCheck> searcher(me, players, checker);
