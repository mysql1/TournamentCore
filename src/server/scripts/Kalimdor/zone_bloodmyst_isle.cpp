        ...
        void WaypointReached(uint32 waypointId) override
        {
            ...
            switch (waypointId)
            {
                ...
                case WP_SIRONAS_HILL:
                {
					...
					Tournament::AllCreaturesOfEntryInRange check(me, NPC_SIRONAS, SIZE_OF_GRIDS);
					Tournament::CreatureSearcher<Tournament::AllCreaturesOfEntryInRange> searcher(me, sironas, check);
