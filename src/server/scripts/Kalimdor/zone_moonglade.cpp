...
public:
    ...
    public:
        ...
        void IsSummonedBy(Unit* /*summoner*/) override
        {
			...
			Tournament::AnyPlayerInObjectRangeCheck checker(me, 5.0f);
			Tournament::PlayerListSearcher<Tournament::AnyPlayerInObjectRangeCheck> searcher(me, playerOnQuestList, checker);
