        ...
        struct npc_crok_scourgebaneAI : public npc_escortAI
        {
            ...
            void WaypointStart(uint32 waypointId) override
            {
                ...
                switch (waypointId)
                {
                    ...
                    case 4:
                    {
						...
						Tournament::CreatureListSearcher<FrostwingVrykulSearcher> searcher(me, temp, check);
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage) override
            {
                ...
                if (!_wipeCheckTimer)
                {
                    _wipeCheckTimer = 1000;
                    Player* player = NULL;
					Tournament::AnyPlayerInObjectRangeCheck check(me, 60.0f);
					Tournament::PlayerSearcher<Tournament::AnyPlayerInObjectRangeCheck> searcher(me, player, check);
                    ...
                    if (!player)
                    {
                        ...
                        if (damage >= me->GetHealth())
                        {
							...
							Tournament::CreatureWorker<FrostwingGauntletRespawner> worker(me, respawner);
    ...
    public:
                ...
                while (uint32 eventId = Events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_ARNATH_PW_SHIELD:
                        {
							...
							DoCast(Tournament::Containers::SelectRandomContainerElement(targets), SPELL_POWER_WORD_SHIELD);
        ...
        private:
            Creature* FindFriendlyCreature() const
            {
				...
				Tournament::MostHPMissingInRange u_check(me, 60.0f, 0);
				Tournament::CreatureLastSearcher<Tournament::MostHPMissingInRange> searcher(me, target, u_check);
    ...
    public:
        ...
        class spell_icc_sprit_alarm_SpellScript : public SpellScript
        {
            ...
            void HandleEvent(SpellEffIndex effIndex)
            {
				...
				wards.sort(Tournament::ObjectDistanceOrderPred(GetCaster()));
    ...
    public:
        ...
        private:
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                if (!targets.empty())
                {
					WorldObject* target = Tournament::Containers::SelectRandomContainerElement(targets);
                    targets.clear();
    ...
    public:
        ...
        class spell_svalna_revive_champion_SpellScript : public SpellScript
        {
            ...
            void RemoveAliveTarget(std::list<WorldObject*>& targets)
            {
				...
				Tournament::Containers::RandomResizeList(targets, 2);
            }
    ...
    public:
        ...
        bool OnTrigger(Player* player, AreaTriggerEntry const* /*areaTrigger*/) override
        {
            ...
            if (instance->GetData(DATA_COLDFLAME_JETS) == NOT_STARTED)
            {
				...
				traps.sort(Tournament::ObjectDistanceOrderPred(player));
                bool instant = false;
