    ...
    public:
        ...
        struct boss_hodirAI : public BossAI
        {
            ...
            void FlashFreeze()
            {
				...
				Tournament::AnyUnfriendlyUnitInObjectRangeCheck checker(me, me, 100.0f);
				Tournament::UnitListSearcher<Tournament::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        {
                            std::list<Unit*> TargetList;
							Tournament::AnyFriendlyUnitInObjectRangeCheck checker(me, me, 30.0f);
							Tournament::UnitListSearcher<Tournament::AnyFriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
