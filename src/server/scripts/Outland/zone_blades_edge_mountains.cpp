        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
				...
				Tournament::AllWorldObjectsInRange objects(me, searchDistance);
				Tournament::WorldObjectListSearcher<Tournament::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
