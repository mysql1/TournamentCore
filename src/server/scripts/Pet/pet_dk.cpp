    ...
    public:
        ...
        struct npc_pet_dk_ebon_gargoyleAI : CasterAI
        {
            ...
            void InitializeAI() override
            {
				...
				Tournament::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 30.0f);
				Tournament::UnitListSearcher<Tournament::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
