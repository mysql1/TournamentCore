    ...
    public:
        ...
        class spell_gen_cannibalize_SpellScript : public SpellScript
        {
            ...
            SpellCastResult CheckIfCorpseNear()
            {
				...
				Tournament::AnyDeadUnitSpellTargetInRangeCheck check(caster, max_range, GetSpellInfo(), TARGET_CHECK_ENEMY);
				Tournament::WorldObjectSearcher<Tournament::AnyDeadUnitSpellTargetInRangeCheck> searcher(caster, result, check);
    ...
    public:
        ...
        class spell_gen_replenishment_SpellScript : public SpellScript
        {
            ...
            void RemoveInvalidTargets(std::list<WorldObject*>& targets)
            {
                ...
                {
					targets.sort(Tournament::PowerPctOrderPred(POWER_MANA));
