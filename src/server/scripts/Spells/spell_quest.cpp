    ...
    public:
        ...
        class spell_q11010_q11102_q11023_choose_loc_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
				...
				Tournament::AnyPlayerInObjectRangeCheck checker(caster, 65.0f);
				Tournament::PlayerListSearcher<Tournament::AnyPlayerInObjectRangeCheck> searcher(caster, playerList, checker);
