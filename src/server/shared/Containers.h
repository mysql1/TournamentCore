...
#ifndef TOURNAMENT_CONTAINERS_H
#define TOURNAMENT_CONTAINERS_H
...
namespace Tournament
{
    namespace Containers
    {
        ...
        /**
        * @fn bool Tournament::Containers::Intersects(Iterator first1, Iterator last1, Iterator first2, Iterator last2)
        *
...
#endif //! #ifdef TOURNAMENT_CONTAINERS_H
