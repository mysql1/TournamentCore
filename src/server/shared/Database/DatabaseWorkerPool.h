...
class DatabaseWorkerPool
{
    ...
    public:
            ...
            _async_threads(0), _synch_threads(0)
        {
            ...
            WPFatal(mysql_get_client_version() >= MIN_MYSQL_CLIENT_VERSION, "TournamentCore does not support MySQL versions below 5.1");
        }
        ...
        */
        ...
        void PExecute(const char* sql, Args const&... args)
        {
			...
			Execute(Tournament::StringFormat(sql, args...).c_str());
        }
        ...
        */
        ...
        void DirectPExecute(const char* sql, Args const&... args)
        {
			...
			DirectExecute(Tournament::StringFormat(sql, args...).c_str());
        }
        ...
        */
        ...
        QueryResult PQuery(const char* sql, T* conn, Args const&... args)
        {
			...
			return Query(Tournament::StringFormat(sql, args...).c_str(), conn);
        }
        ...
        QueryResult PQuery(const char* sql, Args const&... args)
        {
			...
			return Query(Tournament::StringFormat(sql, args...).c_str());
        }
        ...
        */
        ...
        {
			return AsyncQuery(Tournament::StringFormat(sql, args...).c_str());
        }
        ...
        uint32 OpenConnections(InternalIndex type, uint8 numConnections)
        {
            ...
            for (uint8 i = 0; i < numConnections; ++i)
            {
                ...
                if (!error)
                {
                    ...
                    {
                        TC_LOG_ERROR("sql.driver", "TournamentCore does not support MySQL versions below 5.1");
                        error = 1;
                    }
                }
