...
#ifndef TOURNAMENT_TYPECONTAINER_H
#define TOURNAMENT_TYPECONTAINER_H
...
{
    public:
		template<class SPECIFIC_TYPE> size_t Count() const { return Tournament::Count(i_elements, (SPECIFIC_TYPE*)NULL); }

        /// inserts a specific object into the container
        template<class SPECIFIC_TYPE> bool insert(SPECIFIC_TYPE *obj)
        {
			SPECIFIC_TYPE* t = Tournament::Insert(i_elements, obj);
            return (t != NULL);
        }
        ...
        //{
        //    SPECIFIC_TYPE* t = Tournament::Remove(i_elements, obj);
        //    return (t != NULL);
        //}
