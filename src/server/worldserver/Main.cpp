...
/// \addtogroup Tournamentd Tournament Daemon
/// @{
/// \file
...
#ifndef _TOURNAMENT_CORE_CONFIG
    #define _TOURNAMENT_CORE_CONFIG  "worldserver.conf"
#endif
...
char serviceLongName[] = "TournamentCore world service";
char serviceDescription[] = "TournamentCore World of Warcraft emulator world service";
/*
...
/// Launch the Tournament server
extern int main(int argc, char** argv)
{
	std::string configFile = _TOURNAMENT_CORE_CONFIG;
	...
	TC_LOG_INFO("server.worldserver", " _|_|_|_|_|    _|_|    _|    _|  _|_|_|    _|      _|    _|_|    _|      _|  _|_|_|_|  _|      _|  _|_|_|_|_|");  
	TC_LOG_INFO("server.worldserver", "     _|      _|    _|  _|    _|  _|    _|  _|_|    _|  _|    _|  _|_|  _|_|  _|        _|_|    _|      _|");      
	TC_LOG_INFO("server.worldserver", "     _|      _|    _|  _|    _|  _|_|_|    _|  _|  _|  _|_|_|_|  _|  _|  _|  _|_|_|    _|  _|  _|      _|");      
	TC_LOG_INFO("server.worldserver", "     _|      _|    _|  _|    _|  _|    _|  _|    _|_|  _|    _|  _|      _|  _|        _|    _|_|      _|");      
	TC_LOG_INFO("server.worldserver", "     _|        _|_|      _|_|    _|    _|  _|      _|  _|    _|  _|      _|  _|_|_|_|  _|      _|      _|");  
	TC_LOG_INFO("server.worldserver", "__________________________________________________CORE___________________________________________________");
	TC_LOG_INFO("server.worldserver", "World Of Warcraft 3.3.5");
	TC_LOG_INFO("server.worldserver", "Version 1");
	TC_LOG_INFO("server.worldserver", "https://github.com/TournamentCore/TournamentCore");
    ...
    // 0 - normal shutdown
    // 1 - shutdown at error
    // 2 - restart command used, this code can be used by restarter for restart Tournamentd
...
variables_map GetConsoleArguments(int argc, char** argv, std::string& configFile, std::string& configService)
{
    ...
    all.add_options()
		...
		("config,c", value<std::string>(&configFile)->default_value(_TOURNAMENT_CORE_CONFIG), "use <arg> as configuration file")
        ;
#ifdef _WIN32
